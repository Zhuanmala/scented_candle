...
- TikTok corrected public post is live at `https://www.tiktok.com/@jianhou5/video/7653545450997304593`; the old incorrect-caption post was deleted, and TikTok bio now points viewers to the latest post.
- Instagram account `@houjian07122026` is usable. Bio text contains the waitlist URL, and the first tester-recruitment post is live at `https://www.instagram.com/p/DZ1IzfSkmsh/`.
